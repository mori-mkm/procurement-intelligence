"""
Fase 13.4 - Avaliacao do CatBoost v0 na validacao temporal de 2025.

Objetivo:
- treinar exclusivamente em 2024;
- avaliar exclusivamente em 2025;
- usar exatamente a mesma regua do LightGBM;
...
def main():
    print("=" * 70)
    print("FASE 13.4 - CATBOOST V0 | VALIDACAO 2025")
    print("=" * 70)
    ...
    # ---------------------------------------------------------
    # 2. Mesmo escopo utilizado pelo LightGBM
    # ---------------------------------------------------------
    ...
    # 5. Treinar CatBoost
    # ---------------------------------------------------------
    print("\n[5/6] Treinando CatBoost v0...")

    modelo = train_catboost_model(treino)

    log_pred = predict_catboost_model(
        modelo,
        validacao,
    )
    ...
    print("\n" + "=" * 70)
    print("RESULTADO — CATBOOST V0 | VALIDACAO 2025")
    print("=" * 70)
    ...
    metrics_path = (
        OUTPUT_DIR
        / "catboost_v0_validation_2025_metrics.json"
    )
