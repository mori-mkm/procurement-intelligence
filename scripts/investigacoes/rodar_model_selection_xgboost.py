"""
Fase 13.5 - Avaliacao do XGBoost v0 na validacao temporal de 2025.

Objetivo:
- treinar exclusivamente em 2024;
- avaliar exclusivamente em 2025;
- usar exatamente a mesma regua de LightGBM e CatBoost;
- preservar erros por observacao para comparacao pareada futura;
- nao utilizar 2026 durante selecao de modelos.
"""
...
def main():
    print("=" * 70)
    print("FASE 13.5 - XGBOOST V1 | VALIDACAO 2025")
    print("=" * 70)
    ...
    # ---------------------------------------------------------
    # 2. Mesmo escopo utilizado pelos demais modelos
    # ---------------------------------------------------------
    ...
    # 5. Treinar XGBoost
    # ---------------------------------------------------------
    print("\n[5/6] Treinando XGBoost v1...")

    modelo = train_xgboost_model(treino)

    log_pred = predict_xgboost_model(
        modelo,
        validacao,
    )
    ...
    print("\n" + "=" * 70)
    print("RESULTADO — XGBOOST V1 | VALIDACAO 2025")
    print("=" * 70)
    ...
    metrics_path = (
        OUTPUT_DIR
        / "xgboost_v1_validation_2025_metrics.json"
    )
